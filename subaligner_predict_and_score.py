...
with DAG(
    ...
    send_results_to_db = KubernetesPodOperator(
        ...
        env_vars={"SUBALIGNER_loss": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_loss') }}""",
                  "SUBALIGNER_time_load_dataset": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_time_load_dataset') }}""",
                  "SUBALIGNER_audio_file_path": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_audio_file_path') }}""",
                  "SUBALIGNER_video_file_path": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_video_file_path') }}""",
                  "SUBALIGNER_subtitle_file_path": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_subtitle_file_path') }}""",
                  "SUBALIGNER_time_load_dataset": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_time_load_dataset') }}""",
                  "SUBALIGNER_X_shape": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_X_shape') }}""",
                  "SUBALIGNER_time_predictions": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_time_predictions') }}""",
                  "SUBALIGNER_seconds_to_shift": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_seconds_to_shift') }}""",
                  "SUBALIGNER_original_start": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_original_start') }}""",
                  # "SUBALIGNER_Duration": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_Duration') }}""",
                  "SUBALIGNER_Extension": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_Extension') }}""",
                  # "SUBALIGNER_Codec": """{{ task_instance.xcom_pull(task_ids='predict_and_score', key='SUBALIGNER_Codec') }}""",
